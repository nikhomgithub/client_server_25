...
const customerState={
  id: {stType:"number",  validate:valBasic,  pattern:patternNumber, lb:"รหัสลูกค้า"},
  newId:{stType:"number",  validate:valBasic,  pattern:patternNumber, lb:"รหัสลูกค้าใหม่"},
...
const basicDataState={
  ...
  urgency:{stType:"array", validate:valArray, pattern:patternString, lb:"ความด่วน"},
  knowType:{stType:"array", validate:valArray, pattern:patternString, lb:"ประเภทความรู้"},
...
const jobState={
  id:{stType:"number",  validate:valBasic,  pattern:patternNumber, lb:"รหัสงาน"},  
  newId:{stType:"number",  validate:valBasic,  pattern:patternNumber, lb:"รหัสงานใหม่"},
  ...
  file2:{stType:"file",validate:valNone,pattern:null, lb:"ไฟล์2"},
  ...
  urgency:{stType:"string", validate:valBasic,  pattern:patternString, lb:"ความด่วน"},
...
const knowState={
  ...
  dateIn:{stType:"date",  validate:valBasic,  pattern:patternDate, lb:"วันที่จด"},

  file1:{stType:"file",validate:valNone,pattern:null, lb:"ไฟล์1"},
  photoUrl1:{stType:"array",  validate:valArray,    patternFileName, lb:"รูป1"},

  knowType:{stType:"string", validate:valBasic,  pattern:patternString, lb:"ประเภทความรู้"},
  active:{stType:"string", validate:valBasic,  pattern:patternString, lb:"แอคทีฟ"},

  subject:{stType:"string", validate:valBasic,  pattern:patternString, lb: "เรื่อง"},
  remark:{stType:"string", validate:valBasic,  pattern:patternString, lb:"หมายเหตุ"},
