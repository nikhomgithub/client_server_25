...
const { basicData,dataUrl,groupDataUrl,prefixUrl,
        ...
        graphDetailKey,
        dataForm,dataEditForm,dataGroupForm,
...
const reloadAxiosAll=()=>{
    const promise1=axios.post(`/${prefixUrl}${dataUrl}/getlimit`,
                   {pageNumber,limitRow,sort,...qry},myheader)
    const promise2=axios.post(`/${prefixUrl}tabletemplate/getcustom`,{},myheader)
...
const saveTableTemplateAxios=()=>{
    ...
    axios.post(`/${prefixUrl}tabletemplate/updatetabletemplate`,temp,myheader)
}
...
const deleteAxios=()=>{
    ...
    return new Promise((resolve,reject)=>{
        axios.post(`/${prefixUrl}${dataUrl}/${controller}`,
...
const deleteAxiosGroup=()=>{
    return new Promise((resolve,reject)=>{
        axios.post(`/${prefixUrl}${groupDataUrl}/deletegroup`,
...
const addAxiosGroup=(formInputState)=>{
    return new Promise((resolve,reject)=>{
        axios.post(`/${prefixUrl}${groupDataUrl}/addgroup`,formInputState,myheader)
        .then(result=>{
            setReloadGroup(true)
            resolve(true)
        })
...
const editAxiosGroup=(formInputState)=>{
    ...
    return new Promise((resolve,reject)=>{
        axios.post(`/${prefixUrl}${groupDataUrl}/updategroup`,formInputState,myheader)
        .then(result=>{
            setReloadGroup(true)
            resolve(true)
        })
...
const reloadAxiosGroup=()=>{
    if(groupDataUrl){
        axios.post(`/${prefixUrl}${groupDataUrl}/getcustom`,{},myheader)
        .then(result=>{
...
const filterAxios=(option)=>{
    ...
    axios.post(`/${prefixUrl}${dataUrl}/getlimit`,{pageNumber:1,limitRow,sort,...qry},myheader)
    .then(result=>{
...
const submitFunctionAdd=(formInputState)=>{
    ...
    axios.post(`/${prefixUrl}${dataUrl}/${controller}`,fd,myheader)
        .then(result=>{
            setShowAdd(false)
            setReloadData(true)
        })
...
const [badgeState,setBadgetState]=React.useState({
  ...
  const [limitRow,setLimitRow]=React.useState(dfLimitRow)
  ...
  let [qry,setQry]=React.useState(dfQry)
...
return (
    ...
    <div style={{height:"100%",width:"100%",position:'relative'}}>
        ...
        ?<ModalForm
            ...
            stateTemplate={dataState}
            loadData={{id:lastRecordId+1,active:"active"}}
            selectData={{basicData:basicData}}
            setShow={setShowAdd}
