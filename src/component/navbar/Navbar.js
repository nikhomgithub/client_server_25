...
import {FaHome,FaWarehouse,FaUserEdit,FaUsers,FaChartLine,FaBook} from 'react-icons/fa';
...
export default function Navbar() {
    ...
    <div className="navFrame flex-center-center jc-space-between">
            ...
            <div id="1" className="h-100" 
                ...
                <div className="navLink" onClick={e=>refKnow.current.click()}> 
                    <div className="navIconBox">
                        <FaBook className="navIcon"/>
                    </div>
                    <div className="navTextBox">
                        <p className="navText">ความรู้</p>
                    </div>
                </div>
            </div>    
            ...
            <div className="d-none">
                ...
                <Link ref={refUser} to="/p25/user"/>
                <Link ref={refSetting} to="/p25/basicdata"/>
                <Link ref={refCustomer} to="/p25/customer"/>
                <Link ref={refJob} to="/p25/job"/>
                <Link ref={refKnow} to="/p25/know"/>
