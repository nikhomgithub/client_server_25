...
const submitFunctionEdit=(formInputState)=>{
    ...
    axios.post(`/p25basicdata/updatecustom`,temp,myheader)
        .then(result=>{
            setShowEdit(false)
...
const saveRouteAuthTableTemplateAxios=()=>{
    ...
    //console.log('temp')
    //console.log(temp)
    axios.post(`/p25tabletemplate/updatetabletemplate`,temp,myheader)
...
const submitFunctionEditRouteAuth=(formInputState)=>{
    ...
    axios.post(`/p25basicdata/updatecustom`,updateBasicData,myheader)
    .then(result=>{
    ...
    if(reloadRouteAuthTableTemplate){
        ...
        if(localStorage.getItem('shopauthorization')&&
           ...
           //to ensure user&shop token in place before request to server
            ...
            axios.post('/p25tabletemplate/getcustom',
            {},myheader
            /*
...
const renderSelect=()=>{
    ...
    const arrs=[
        ...
        {lb:"แอคทีฟ",name:"active",
            cName:"xc12 sc12 p-1 flex-center-baseline",
            subCName:["xc4 sc12 ","xc8 sc12"]},

        {lb:"ความด่วน",name:"urgency",
            cName:"xc12 sc12 p-1 flex-center-baseline",
            subCName:["xc4 sc12 ","xc8 sc12"]},

        {lb:"ประเภทความรู้",name:"knowType",
            cName:"xc12 sc12 p-1 flex-center-baseline",
            subCName:["xc4 sc12 ","xc8 sc12"]},
